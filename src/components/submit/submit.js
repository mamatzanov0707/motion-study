                ...
                <div className="message">
                    ...
                    <div className='message--help'>
                        ...
                        <div className='message--help__icons'>
                            ...
                            <a href="tel:+996 500 34 84 39">+996 500 34 84 39</a>
                        </div>
                        <div className='message--help__icons'>
                            <AiOutlineMail className='text-3xl' style={{color: 'white'}}/>
                            <h4>motionweb312@gmail.com</h4>
                        </div>
                        ...
                        <div className='message--help__cop'>
                            <div onClick={() => setSend(!send)} style={{cursor:'pointer'}} className='message--help__cop--com'>
